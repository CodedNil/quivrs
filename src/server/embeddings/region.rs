...
pub const fn labels(region: Region) -> &'static [&'static str] {
    match region {
        Region::Global => &[
            ...
            "Location-independent digital culture: internet culture, software deployment, open-source programming, developer tooling, workspace managers, compiler engineering, register allocation, runtime optimization, web applications, prompt workflows, router configuration, wireless signal advice.",
            "Location-independent consumer and media guides: streaming television guides, online viewing options, drama series releases, mystery thrillers, entertainment reviews, shopping guides, deal roundups, product comparisons, general lifestyle advice.",
            "General consumer product coverage: retail brand launches, product reviews, shopping advice, market promotions, universal product categories, worldwide consumer trends, location-neutral automotive product news, electric vehicle product coverage.",
            "Universal hobby topics: general gardening, tomato planting, agricultural botany, global flora, worldwide internet trends, viral news.",
        ],

        // Great Britain
        Region::UnitedKingdom => &[
            "United Kingdom: UK, U.K., Great Britain, Britain, British, Briton, British national scope, nationwide UK territory, Westminster administration, Whitehall departments, Downing Street executive, Parliament legislation, UK sovereign governance, British national infrastructure, nationalised utilities, water companies, energy companies, birth rates across England and Wales, NHS, British families, British courts, British sentencing, UK sentencing review, British medical misdiagnosis, King's College London, UK team, UK university research teams, UK scientific researchers, London university research, British quantum computing research, British academic science teams, Royal Navy, Isle of Man, Crown dependencies.",
            "UK consumer economy and institutions: sterling currency, pound sterling finance, GBP banknotes, British pound pricing, £ symbol, £350, £9.99, £499.99, £500, pound-denominated gadget discounts, pound price drops, UK retail sale prices, British online deals, city centre cafe prices, high street prices, domestic household energy bills, national utility regulators, British retail costs, grocery prices, food production investment, supplier agreements, British grocery supply chains, cost-of-living pressures, Lloyds, Halifax, Bank of Scotland.",
        ],
        Region::England => &[
            "England: English territory, Anglo geography, English municipalities, English local government councils, English regional constituencies, London metro, Manchester urban area, Manchester University, Russell Group university in Manchester, Birmingham district, Liverpool region, Yorkshire counties, Midlands, English shires, southern counties, northern English towns, Kent, Oxford, Surrey, Guildford, Hampshire, Farlington, Devon, Kingsbury country park, Lord's cricket ground, Norfolk, Suffolk, Norfolk-Suffolk border, East Anglia, Waveney valley, River Waveney land, English river land purchases, English council wildlife access, English inland waterways, English environmental zones, regional preservation sites, community parklands, Bournemouth Beach, Cardingmill Valley, Shrewsbury, River Waveney, National Trust property, English coastlines, English local attractions, English towns, English beaches, coastal incidents, local incidents, heritage appeals, local conservation appeals, countryside cleanup appeals, bank holiday weekend, rural littering, heritage landmarks, England domestic bills, local marketplace transactions.",
        ],
        Region::Scotland => &[
            "Scotland: Scottish nation, Scots territory, Scottish highlands, Scottish lowlands, Scottish regional authorities, Scottish island chains, Holyrood administration, Scottish parliament, Edinburgh metro, Glasgow urban area, Aberdeen district, Ayrshire, Scottish municipal councils, historic Scottish burghs, local Scottish waterways, Scottish pound notes, local Scottish retail transactions.",
        ],
        Region::Wales => &[
            "Wales: Welsh nation, Cymru territory, Welsh uplands, Welsh regional authorities, local Welsh municipal districts, Senedd administration, Cardiff metro, Swansea urban area, Newport district, Talbot Green, Pembrokeshire, Welsh county councils, Welsh coastal zones, Welsh beaches, Welsh seaside incidents, Welsh shoreline litter, historic Welsh principalities, Welsh regional transactions, local Welsh community funding.",
        ],
        Region::Ireland => &[
        ...
        // North America
        Region::UnitedStates => &[
            "United States: USA, US, U.S., America, American, Washington DC executive, federal governance, American nationwide scope, California state, Texas territory, New York geography, New York State, Minnesota, San Francisco, Bay Area, San Francisco events, San Francisco lightning talks, California AI events, California panel discussions, Florida peninsula, Washington state, Midwest, Pacific Northwest, New England, major American metropolitan areas, US state legislatures, American municipal counties, domestic US interstate commerce, American regional infrastructure.",
            "US public institutions and commerce: United States dollar currency, USD bills, $ symbol, dollar pricing, American retail ads, online shopping deals, holiday sales, Memorial Day, White House, US first lady, former first lady, US attorney general, federal court prosecutions, federal prosecutors, Wall Street, Nasdaq, US federal agencies, American tech headquarters, Silicon Valley corporate news, corporate headquarters, venture capital, business regulation.",
        ],
        Region::Canada => &[
        ...
        Region::WesternEurope => &[
            "Western Europe: Benelux, Netherlands, Dutch, Amsterdam, Rotterdam, Belgium, Belgian, Brussels, Luxembourg, Antwerp, Monaco, Monte Carlo, Monaco Grand Prix, western Europe heat dome, western European temperature records, Benelux national news, continental Europe, European Union, EU, Brussels, eurozone, Schengen, European institutions, and pan-European coverage.",
        ],
        ...
        Region::China => &[
            "China: Chinese, People's Republic of China, Beijing, Shanghai, Shenzhen, Guangzhou, Wuhan, Sichuan, Guangdong, Zhejiang, Xinjiang, Hong Kong, Hongkonger, Hong Kong payload scientist, Kowloon, Macau, Macanese, Victoria Harbour, New Territories.",
        ],
        Region::Japan => &[
