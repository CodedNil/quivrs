...
pub const fn labels(category: Category) -> &'static [&'static str] {
    match category {
        ...
        Category::Business => &[
            ...
            "Finance and the economy: markets, stocks, shares, bonds, banking, lending, mortgages, pensions, insurance, inflation, interest rates, taxation, wages, trade, productivity, growth, exports, imports, prices, tariffs, coffee prices, global economic turmoil, and market conditions.",
        ...
        Category::Politics => &[
            "Government, parliament, ministers, legislation, public administration, budgets, public services, civil service, planning officers, regulation, public sector staffing, policy decisions, housing policy, first-time buyers, interest-free loans, grants, public funds, nationalisation, public ownership, water companies, energy companies, schools policy, migration, and local government.",
            ...
            "Foreign affairs and national security: diplomacy, defence policy, armed forces, intelligence agencies, GCHQ, espionage, hostile states, Russia, China, Israel, Lebanon, air strikes, evacuation orders, sanctions, treaties, war, infrastructure threats, democracy threats, and relations between states.",
        ...
        Category::Law => &[
            "Courts, justice, legal process, trials, judges, lawsuits, appeals, rulings, rights, liability, sentencing, prisons, constitutional judgments, compensation claims, environmental litigation, corporate liability, fraud charges, insider trading, confidential data, prosecutors, and government legal action.",
        ...
        Category::Health => &[
            ...
            "Disease and public health: cancer, oncology, infections, outbreaks, chronic illness, mental illness, addiction, mortality, birth rates, fertility rates, live births, population health, vaccination, prevention, diagnosis, treatment, patient safety, and safeguarding concerns.",
        ...
        Category::Culture => &[
            ...
            "Media and cultural life: broadcasters, documentaries, presenters, podcasts, journalism, media controversies, celebrities, famous personalities, identity, public attitudes, heritage, chalk figure, historic figure, National Trust, cities, traditions, language, racism, and society.",
        ...
        Category::Lifestyle => &[
            ...
            "Consumer shopping and personal life: mattresses, clothing, shoes, appliances, outdoor goods, Amazon deals, Walmart deals, Currys deals, home accessories, sales, discounts, buying guides, food, drink, restaurants, holidays, travel, hotels, leisure, hobbies, dating, family life, beauty, fashion, and style.",
        ...
        Category::Nature => &[
            ...
            "Climate, weather, and environmental harm: climate change, global warming, emissions, heatwaves, temperature records, flooding, drought, storms, wildfires, pollution, littering, waste, sewage, contaminated rivers, ecosystem damage, and sustainability.",
            "Earth systems and waterways: oceans, beaches, beach litter, coasts, valleys, National Trust land, dead fish, washed up sea life, discarded catch, rivers, watercourses, landscapes, geology, earthquakes, volcanoes, environmental monitoring, ecological research, renewables, net zero, and recycling.",
        ],
        // Physical consumer electronics, computing devices, and hardware products.
        Category::Technology => &[
            "Consumer electronics and hardware: phones, tablets, iPads, iPad Air, laptops, televisions, TVs, screens, TV sale, screen sale, Best Buy, home cinema, physical cameras, headphones, speakers, routers, smart home devices, wearables, smartwatches, fitness trackers, smart rings, VR headsets, AR glasses, accessories, and gadgets.",
        ...
        Category::Gaming => &[
            ...
            "Gaming hardware and promotions: controllers, game consoles, gaming PCs, gaming handhelds, virtual-reality games, PS5 games, Switch games, Steam Deck, and video game discounts.",
        ],
    }
}
